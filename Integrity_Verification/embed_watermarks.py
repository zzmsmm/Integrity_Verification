...
try:
    ...
    if args.method == 'ProtectingIP':
        log_dir = os.path.join(cwd, 'log', str(args.dataset), str(args.arch), 'watermark', str(args.wm_type))
    elif args.method == 'FrontierStitching':
        log_dir = os.path.join(cwd, 'log', str(args.dataset), str(args.arch), 'watermark', 'frontier_stitching')
    elif args.method == 'ExponentialWeighting':
        log_dir = os.path.join(cwd, 'log', str(args.dataset), str(args.arch), 'watermark', 'exponential_weighting')
    ...
    if args.method == 'ProtectingIP':
        ...
        save_dir = os.path.join(cwd, 'checkpoint', str(args.dataset), str(args.arch), 'watermark', 'frontier_stitching')
    elif args.method == 'ExponentialWeighting':
        save_dir = os.path.join(cwd, 'checkpoint', str(args.dataset), str(args.arch), 'watermark', 'exponential_weighting')
