...
def set_up_optim_sched(args, net):
    ...
    if args.sched == 'MultiStepLR_cifar10_vgg16':
        scheduler = MultiStepLR(optimizer, milestones=[30, 50, 60, 80, 100, 120, 140, 160, 180], gamma=args.lradj)
    elif args.sched == 'MultiStepLR_caltech101_resnet18':
        scheduler = MultiStepLR(optimizer, milestones=[35, 50, 70, 80, 100, 120, 140, 160, 180], gamma=args.lradj)
    elif args.sched == 'MultiStepLR_tiny-imagenet_vit':
        scheduler = MultiStepLR(optimizer, milestones=[40, 60, 80, 100, 120, 140, 160, 180], gamma=args.lradj)
    elif args.sched == 'MultiStepLR_tiny-imagenet_resnet50':
        scheduler = MultiStepLR(optimizer, milestones=[40, 60, 80, 100, 120, 140, 160, 180], gamma=args.lradj)
