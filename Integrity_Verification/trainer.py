...
def train(epoch, net, criterion, optimizer, train_loader, device, avg_train_losses, avg_valid_losses,
    ...
    logging.info(('Epoch %d: Train loss: %.3f | Valid loss: %.3f | Train Acc: %.3f%% (%d/%d) | Valid Acc: %.3f%% (%d/%d)'
                  % (epoch, train_loss, valid_loss, train_acc, correct, total, valid_acc, correct_valid, total_valid)))
